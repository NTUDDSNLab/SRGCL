...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in dataloader:
            ...
            x_aug = []
            for i in range(len(data_batch_augmentations)):
                x_aug.append(model(data_batch_augmentations[i].x, data_batch_augmentations[i].edge_index, data_batch_augmentations[i].batch, data_batch_augmentations[i].num_graphs))
